...
public class ChessMatch {
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, 
		...
		//validando se existe uma peça
		
		validateSourcePosition(source);
		
		//validando posiçao de destino
	...
	private void validateSourcePosition(Position position) {
		...
		if(!board.thereIsAPiece(position)) {
			...
			throw new ChessException("Nao  há peça nessa posiçao!");
	...
	private ChessPiece king(Color color) {
		...
		List<Piece> list = 
				piecesOnTheBoard.stream().filter(x -> ((ChessPiece)x).getColor()
		...
		throw new IllegalStateException("Nao existe o rei " + color + " Rei no tabuleiro ");
